...
export class BecaService {
  ...
  getBecasDisponibles() {
    return this.http.get(`${this.URL}/admin/beca/becas-disponibles`)
  }
  ...
  getOne(codigo_beca: any) {
    return this.http.get(`${this.URL}/admin/beca/${codigo_beca}`)
  }

  // actualizar beca
  updateBeca(codigo_beca: any, beca: any) {
    return this.http.put(`${this.URL}/admin/beca/update/${codigo_beca}`, beca)
  }

  // elimina las becas con los servicios que los cubre
  deleteBecasWhitService(codigo_beca: any, id_alumno: any) {
    return this.http.delete(`${this.URL}/admin/beca/beca_alumno/delete/${codigo_beca}/${id_alumno}`)
  }
